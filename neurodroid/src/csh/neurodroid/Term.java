...
import csh.neurodroid.util.AndroidCompat;
import csh.neurodroid.util.SessionList;
import csh.neurodroid.util.TermSettings;
...
public class Term extends Activity implements UpdateCallback {
    ...
    public static final String EXTRA_WINDOW_ID = "csh.neurodroid.window_id";
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.androidterm, menu);
        return true;
    }
