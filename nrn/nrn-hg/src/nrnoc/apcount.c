	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  hoc_register_dparam_size(_mechtype, 2);
 	...
 	ivoc_help("help ?1 APCount /home/cs/neurodroid/nrn/src/nrnoc/../.././nrn-hg/src/nrnoc/apcount.mod\n");
...
static int  record ( _p, _ppvar, _thread, _nt ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; {
...
static double _hoc_record(_vptr) void* _vptr; {
 double _r;
   double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt;
   _p = ((Point_process*)_vptr)->_prop->param;
  _ppvar = ((Point_process*)_vptr)->_prop->dparam;
